...
- The live public record now contains **22 direct external pull-request merges**, including **16 PCF-era direct merges**. Maintainer-authored Hermes salvage and open credit remain separate from both counts.
